          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="/app"
                        className={`text-white text-white group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/" ||
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/app/"
                              className={`text-white text-white group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-white duration-300 ease-in-out hover:text-white ${
                                pathname === "/" && "text-white"
                              }`}
                            >
                              eCommerce
              ...
              <li>
                <Link
                  href="/app/profile"
                  className={`text-white group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
