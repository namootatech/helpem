  ...
  return (
    <Layout>
      <div className="container mt-4 px-16 py-20">
        <h1 class="max-w-lg text-3xl font-semibold leading-normal text-gray-900 dark:text-white mb-2">
          Ending Hunger in Africa
        </h1>
        <p class="text-left text-gray-500 dark:text-gray-400 mt-2 mb-12">
        ...
        <h4 class="max-w-lg text-3xl font-semibold leading-normal text-gray-900 dark:text-white mb-2">
          The Challenge
        </h4>
        <p class="text-left text-gray-500 dark:text-gray-400 mt-2 mb-12">
        ...
        <p class="text-left text-gray-500 dark:text-gray-400 mt-2 mb-12">
          Help'em takes a holistic approach to tackling hunger in Africa. We are
          committed to:
          <ul>
            <li>
        ...
        <h4 class="max-w-lg text-3xl font-semibold leading-normal text-gray-900 dark:text-white my-2">
        ...
        <h4 class="max-w-lg text-3xl font-semibold leading-normal text-gray-900 dark:text-white mb-2">
          JMake a Difference Today
        </h4>
        <p class="text-left text-gray-500 dark:text-gray-400 mt-2 mb-12">
          {" "}
          HYour support can change lives, one meal at a time. Join us in the
