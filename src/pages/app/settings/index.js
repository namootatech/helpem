...
const Settings = ({ user }) => {
  ...
  const handleImageChange = async (e) => {
    ...
    if (file) {
      ...
      data.append('upload_preset', 'ezkr3dpz'); // Replace 'your_cloudinary_upload_preset' with your actual Cloudinary upload preset

      // Upload image to Cloudinary
      try {
        const response = await fetch(
          'https://api.cloudinary.com/v1_1/dtxlgn7mq/image/upload',
          {
            method: 'POST',
            body: data,
          }
